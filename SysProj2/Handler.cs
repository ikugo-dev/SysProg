...
public class Handler
{
    ...
    bool _logFileLocation;
    bool _saveToFile;
    public Handler(bool logFileLocation, bool saveToFile)
    {
    ...
    public void Handle(HttpListenerContext context)
    {
        ...
        if (_logFileLocation) Console.WriteLine($"Found {inputFileName} at: {inputFilePath}");
        ...
        if (_saveToFile) File.WriteAllText("./output.txt", _cache[inputFileName]);
    }
